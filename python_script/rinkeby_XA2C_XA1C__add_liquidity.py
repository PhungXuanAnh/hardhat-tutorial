...
print("Operator have gave router {} XA1C ".format(XA1C_allowance / DECIMAL))

XA2C_allowance = XA2C.functions.allowance(OPERATOR_ADDRESS, UNISWAP_ROUTER_V2_ADDRESS).call()
print("Operator have gave router {} XA2C ".format(XA2C_allowance / DECIMAL))
...
print('balance XA1C of account 2: ', XA1C.functions.balanceOf(ACCOUNT_2_ADDRESS).call() / DECIMAL)
print('balance XA2C of account 2: ', XA2C.functions.balanceOf(ACCOUNT_2_ADDRESS).call() / DECIMAL)
